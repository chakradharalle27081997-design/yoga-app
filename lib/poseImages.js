...
const ALIAS_MAP = {
  ...
  "ardha shalabhasana":                          "Ardha Shalabhasana (Half Locust Pose).png",
  "shalabhasana":                                "Shalabhasana (Locust Pose).jpeg",
  "salabhasana":                                 "Shalabhasana (Locust Pose).jpeg",
  "poorna salabhasana":                          "Poorna Shalabhasana (Full Locust Pose).jpeg",
  "viparita salabhasana":                        "Viparita Shalabhasana (Superman Pose).jpeg",
  "ardha salabhasana":                           "Ardha Shalabhasana (Half Locust Pose).png",
  "locust pose":                                 "Shalabhasana (Locust Pose).jpeg",
  "poorna shalabhasana":                         "Poorna Shalabhasana (Full Locust Pose).jpeg",
  "full locust pose":                            "Poorna Shalabhasana (Full Locust Pose).jpeg",
  "viparita shalabhasana":                       "Viparita Shalabhasana (Superman Pose).jpeg",
  "superman pose":                               "Viparita Shalabhasana (Superman Pose).jpeg",
  "viparita karani":                             "Viparita Karani (Legs Up The Wall).jpeg",
  "legs up the wall":                            "Viparita Karani (Legs Up The Wall).jpeg",
  "half locust pose":                            "Ardha Shalabhasana (Half Locust Pose).png",
  "ekapadottanasana":                            "Ekapadottanasana (Single Leg Raise).jpeg",
  "single leg raise":                            "Ekapadottanasana (Single Leg Raise).jpeg",
  "dwipadottanasana":                            "Dwipadottanasana (Double Leg Raise).jpeg",
  "double leg raise":                            "Dwipadottanasana (Double Leg Raise).jpeg",
  "supta padangusthasana":                       "Supta Padangusthasana (Supine Big Toe Pose).png",
  "uttanasana yoga mudra":                       "Uttanasana Yoga Mudra (Standing Forward Fold Yoga Mudra).png",
  "eka pada pawanamuktasana":                    "Eka Pada Pawanamuktasana (One-Legged Wind Relieving Pose)_02.png",
  "eka pada pawanamuktasana variation":          "Eka Pada Pawanamuktasana (One-Legged Wind Relieving Pose).png",
  ...
  "jathara parivartanasana":                     "Ardha Matsyendrasana (Spinal Twist).jpg",
  "supine spinal twist":                         "Ardha Matsyendrasana (Spinal Twist).jpg",
