    ...
    <div style={{ minHeight: "100vh", background: "#f0f7f4", padding: "1rem" }}>
      <div style={{ maxWidth: "500px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
          ...
          <h1 style={{ fontSize: "1.4rem", fontWeight: 800, color: "#1D9E75" }}>IRA Yoga Studio</h1>
        ...
        <p style={{ textAlign: "center", fontSize: "0.75rem", color: "#9ca3af", marginTop: "1rem" }}>IRA Yoga Studio · Your data is safe and private</p>
      </div>
    </div>
  );
}
